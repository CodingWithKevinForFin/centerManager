...
public class AmiCenterGraphNode_Table extends AmiCenterGraphAbstractNode {
	...
	//A source trigger moves the data out of the table. The arrow should point from the table to the trigger
	private List<AmiCenterGraphNode_Trigger> sourceTriggers = new ArrayList<AmiCenterGraphNode_Trigger>();

	//A sink trigger directs the data into the table. The arrow should point from the trigger to the table
	private List<AmiCenterGraphNode_Trigger> sinkTriggers = new ArrayList<AmiCenterGraphNode_Trigger>();
