...
public class AmiCenterManagerSubmitTriggerPortlet extends GridPortlet implements AmiWebSpecialPortlet, FormPortletListener, HtmlPortletListener {
	...
	public AmiCenterManagerSubmitTriggerPortlet(AmiWebService service, PortletConfig config, String previewScript) {
		super(config);
